...
def create_file():
    ...
    df.to_csv('./data/processed/first_date_crypto_list.csv', index=False)
...
df_date = pd.read_csv('./data/processed/first_date_crypto_list.csv')
...
other_crypto.to_csv(f'./data/processed/first_{number_of_crypto}_crypto_list.csv')
