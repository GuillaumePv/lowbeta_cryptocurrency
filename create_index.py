...
df = pd.read_pickle(f"data/bitcoin.pkl")
#print(df.head(5))

files = os.listdir('./data/')

df_base = pd.read_pickle(f"data/{files[0]}")
...
df_base.to_csv('./market_cap_crypto.csv', index=False)
df_base_price.to_csv('./close_price_crypto.csv', index=False)