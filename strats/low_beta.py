...
df_metrics.loc["Low Beta", "HHI"] = herfindahl
herfindahl = getHerfindahl(df_weights_high)
df_metrics.loc["High Beta", "HHI"] = herfindahl
df_metrics.to_csv(f"{path_data_processed}/df_metrics_{c.number_cryptos}_1e{marketcap[-1]}.csv")
...
df_price_7.to_csv(f"{path_data_strat}/Low_Beta_price_{c.number_cryptos}_1e{marketcap[-1]}_reb7.csv")
...
df_metrics_7.to_csv(f"{path_data_processed}/df_metrics_{c.number_cryptos}_1e{marketcap[-1]}_reb7.csv")
df_price_7.to_csv(f"{path_data_strat}/High_Beta_price_{c.number_cryptos}_1e{marketcap[-1]}_reb7.csv")
...
df_metrics_30.to_csv(f"{path_data_processed}/df_metrics_{c.number_cryptos}_1e{marketcap[-1]}_reb30.csv")
df_price_30.to_csv(f"{path_data_strat}/High_Beta_price_{c.number_cryptos}_1e{marketcap[-1]}_reb30.csv")
