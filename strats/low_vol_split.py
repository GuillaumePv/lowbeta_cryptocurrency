#program message
print(40*"=")
print("Low_Vol strat is doing splits...")
print(40*"=")
...
cut_date = "2019-02-01" #date where the data is cut (can be modified here)

#get returns and split them
...
#set up variables for configuration and metrics
views = 0
array_sign_stat = []

df = [df_returns_before, df_returns_after]

for df_returns in df: #do the low vol 2 times for the different datasets
    #volatility
    ...
    for df in [df_price_low, df_price_high]: #create metrics for high and low performance
        ...
        #excess_returns (change benchmark in function of the dataset)
        if views < 2:
