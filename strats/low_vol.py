...
df_price_7.to_csv(f"../data/strats/Low_Vol_price_{c.number_cryptos}_1e{marketcap[-1]}_reb7.csv")
...
df_metrics_7.to_csv(f"../data/processed/df_metrics_{c.number_cryptos}_1e{marketcap[-1]}_reb7.csv")
df_price_7.to_csv(f"../data/strats/High_Vol_price_{c.number_cryptos}_1e{marketcap[-1]}_reb7.csv")
...
df_price_30.to_csv(f"../data/strats/Low_Vol_price_{c.number_cryptos}_1e{marketcap[-1]}_reb30.csv")
...
df_metrics_30.to_csv(f"../data/processed/df_metrics_{c.number_cryptos}_1e{marketcap[-1]}_reb30.csv")
df_price_30.to_csv(f"../data/strats/High_Vol_price_{c.number_cryptos}_1e{marketcap[-1]}_reb30.csv")
