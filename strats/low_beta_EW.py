...
df_returns_EW = pd.read_csv(f"../data/processed/EW_perf_{c.number_cryptos}_1e{marketcap[-1]}.csv", index_col=0)
...
df_price_low.to_csv(f"../data/strats/Low_Beta_EW_price_{c.number_cryptos}_1e{marketcap[-1]}.csv")

df_perf_high = df_returns_high.sum(axis=1)
df_perf_high[0] = 0
df_price_high = df_perf_high.add(1).cumprod()*100
#print(df_price_high.tail(3))
df_price_high.to_csv(f"../data/strats/High_Beta_EW_price_{c.number_cryptos}_1e{marketcap[-1]}.csv")
...
df_price_7.to_csv(f"../data/strats/Low_Beta_EW_price_{c.number_cryptos}_1e{marketcap[-1]}_reb7.csv")
...
df_metrics_7.to_csv(f"../data/processed/df_metrics_{c.number_cryptos}_1e{marketcap[-1]}_reb7.csv")
df_price_7.to_csv(f"../data/strats/High_Beta_EW_price_{c.number_cryptos}_1e{marketcap[-1]}_reb7.csv")
...
df_price_30.to_csv(f"../data/strats/Low_Beta_EW_price_{c.number_cryptos}_1e{marketcap[-1]}_reb30.csv")
...
df_metrics_30.to_csv(f"../data/processed/df_metrics_{c.number_cryptos}_1e{marketcap[-1]}_reb30.csv")
df_price_30.to_csv(f"../data/strats/High_Beta_EW_price_{c.number_cryptos}_1e{marketcap[-1]}_reb30.csv")
